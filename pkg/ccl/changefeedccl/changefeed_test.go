...
func TestChangefeedErrors(t *testing.T) {
	...
	sqlDB.ExpectErr(
		t, `option webhook_client_timeout must be a positive integer`,
		`CREATE CHANGEFEED FOR foo INTO $1 WITH webhook_client_timeout='not_an_integer'`, `webhook-https://fake-host`,
	)
	sqlDB.ExpectErr(
		t, `option webhook_client_timeout must be a positive integer`,
		`CREATE CHANGEFEED FOR foo INTO $1 WITH webhook_client_timeout='0'`, `webhook-https://fake-host`,
	)
	sqlDB.ExpectErr(
		t, `option webhook_client_timeout must be a positive integer`,
		`CREATE CHANGEFEED FOR foo INTO $1 WITH webhook_client_timeout='-500'`, `webhook-https://fake-host`,
	)
	sqlDB.ExpectErr(
		t, `option webhook_client_timeout must be a positive integer`,
